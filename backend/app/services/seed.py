...
SEED_PRODUCTS = [
    {
        ...
        "minimum_tenure": 12,
        "maximum_tenure": 60,
        "eligibility_rules": {"max_foir": 45, "employment_types": ["salaried", "self-employed"]},
    },
    {
        "name": "Salary Advance",
    ...
    },
    {
        ...
        "minimum_tenure": 3,
        "maximum_tenure": 12,
        "eligibility_rules": {"max_foir": 30, "employment_types": ["salaried", "self-employed"]},
    },
    {
        "name": "SME Loan",
        ...
        "minimum_tenure": 12,
        "maximum_tenure": 84,
        "eligibility_rules": {"max_foir": 50, "employment_types": ["self-employed", "business-owner"]},
    },
    {
        "name": "Secured Loan",
        ...
        "minimum_tenure": 12,
        "maximum_tenure": 180,
        "eligibility_rules": {"max_foir": 55, "employment_types": ["salaried", "self-employed", "business-owner"]},
    },
    {
        "name": "Top Up Loan",
        "description": "Additional borrowing for existing borrowers with repayment history.",
        "interest_rate": 10.0,
...
def seed_loan_products(db: Session) -> None:
    existing_count = db.query(LoanProduct).count()
    if existing_count > 0:
        return

    for product in SEED_PRODUCTS:
        db.add(LoanProduct(**product))
    db.commit()
